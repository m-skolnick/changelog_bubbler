...
class ChangelogBubbler extends CommandRunner<int> {
  ...
  ChangelogBubbler({String? workingDirectory})
    ...
    argParser.addOption(
      'json-output',
      help:
          'The output file for a json list of changed dependencies. Not generated by default',
    );
    argParser.addFlag(
      'dev',
    ...
    argParser.addOption(
      'changelog-name',
      help: 'The name of the changelogs to search for',
  ...
  Future<int> run(Iterable<String> args) async {
    ...
    try {
      ...
      final changelogBuilder = ChangelogBuilder(
        ...
        templateManager: TemplateManager(configManager)..init(),
      );
      Logger.progressSuccess(prompt);
